...
public class LabRat {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.name.equals(r.name) && this.age == r.age && this.weight == r.weight
                && this.isAlive == r.isAlive && Arrays.equals(this.survivingExperiments, r.survivingExperiments)
                && this.aByte == r.aByte && this.aShort == r.aShort && this.aFloat == r.aFloat
                && this.strings.containsAll(r.strings) && Arrays.equals(this.array, r.array)) {
            return true;
        }
        return false;
    }
